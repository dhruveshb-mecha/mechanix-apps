...
# how to get settings could be as easy as but default to a git checkout:
# SRC_URI += "crate://crates.io/settings/1.0.0"
SRC_URI += "git://git@github.com/dhruveshb-mecha/mechanix-apps.git;protocol=ssh;nobranch=1;branch=main"
SRCREV = "5e7e3bfc530159db91fae2122f96fdbbd5da70f0"
S = "${WORKDIR}/git"
CARGO_SRC_DIR = "apps/settings"
PV:append = ".AUTOINC+5e7e3bfc53"
...
SRC_URI += " \
    ...
    crate://crates.io/fdeflate/0.3.3 \
...
"
DEPENDS:append = " pkgconfig pkgconfig-native gdk-pixbuf gtk4-layer-shell  libadwaita  gtk4 udev alsa-lib wayland wayland-utils dbus protobuf-c nativesdk-protobuf protobuf-c-native"
...
SUMMARY = "Collection of UI elements for a UI Shell for Mecha devices, supports wlroots based compositors"
